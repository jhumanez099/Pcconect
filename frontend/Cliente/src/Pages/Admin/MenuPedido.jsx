    ...
    () => [
      {
        ...
        desc: "Genera un nuevo pedido con sus ítems y condiciones.",
      },
      {
        nombre: "Consultar",
        ruta: "/ConsultarPedido",
        icon: "bi-clipboard-data",
        desc: "Busca, visualiza y administra pedidos existentes.",
      },
    ],
    []
  );
      ...
      <div className="min-vh-100 d-flex flex-column bg-light">
        ...
        <main className="container flex-grow-1 py-4">
          ...
          <header className="mb-4">
            <h1 className="h3 mb-1">Menú Pedido</h1>

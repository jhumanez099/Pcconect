    ...
    () => [
      {
        ...
        desc: "Registra un nuevo equipo con sus características técnicas.",
      },

      {
        nombre: "Consultar",

        ruta: "/ConsultarEquipo",

        icon: "bi-wrench",

        desc: "Busca, visualiza y gestiona el inventario de equipos.",
      },
    ],
      ...
      <div className="min-vh-100 d-flex flex-column bg-light">
        ...
        <main className="container flex-grow-1 py-4">
          ...
          <header className="mb-4">
            <h1 className="h3 mb-1">Menú Equipo</h1>

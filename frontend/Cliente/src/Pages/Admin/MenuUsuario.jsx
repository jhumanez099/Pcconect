...
export default function MenuUsuario() {
    ...
    () => [
      {
        ...
        ruta: "/CrearUsuario",
        icon: "bi-person-plus",
        desc: "Registra un nuevo usuario y asigna sus credenciales y permisos.",
      },
      {
        nombre: "Consultar",
        ruta: "/ConsultarUsuario",
        icon: "bi-search",
        desc: "Busca, visualiza y gestiona usuarios existentes.",
      },
    ],
    []
  );
  ...
  return (
    <>
      {/* CSS incrustado para animación hover/focus */}
      <style>{`
        .liftable {
      ...
      <div className="min-vh-100 d-flex flex-column bg-light">
        ...
        <main className="container flex-grow-1 py-4">
          ...
          <header className="mb-4">
            <h1 className="h3 mb-1">Menú Usuario</h1>
